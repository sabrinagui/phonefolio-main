          ...
          <div className="flex items-center justify-between mb-5">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm text-gray-500 ml-3">
                Portfólio de websites e aplicações web
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="flex flex-col">
            {projects.map((project, index) => (
              <a
                ...
                className="drop-shadow-md card bg-white rounded-lg px-5 py-4 gap-x-4 flex flex-col md:flex-row items-center hover:-translate-y-1 hover:scale-100 duration-300 transition ease-in-out delay-150 hover:shadow-sm border border-gray-200 hover:border-gray-300"
              ...
              >
                ...
                <div className="ml-auto hidden md:block text-sm font-medium text-gray-500">
                  Ver projeto
                </div>
              </a>
            ))}

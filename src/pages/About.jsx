...
export default function About() {
  ...
  <div className="flex flex-col md:flex-row items-center gap-2">
    <a href={configData.hireMeLink}>
      <button
        type="button"
        className="gap-x-1 relative overflow-hidden border border-[#000000] bg-[#050708] text-white shadow-2xl transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:before:-translate-x-40 font-medium rounded-lg text-sm px-2 py-2 inline-flex items-center"
      >
        {/* SVG do Contrate-me */}
        <svg
